...
INSERT INTO Producto (ID_Producto_PK, ID_Tipo_Producto_FK, Nombre_Producto, Descripcion, Precio_Proveedor, Precio_Venta, Foto_Producto, ID_Estado_FK)
 VALUES ('AGU-001', 1, 'Agua Mineral', '600 ml', 1000.00, 1500.00, 'url_agua_mineral.jpg', 1),
        ('ARR-001', 3, 'Arroz', '5 kilos', 5000.00, 6000.00, 'url_arroz.jpg', 0),
        ('POK-001', 1, 'Poker', '330 ml', 2500.00, 3000.00, 'url_cerveza.jpg', 1),
        ('JUG-001', 4, 'Jugo de Naranja', '1 Litro', 3000.00, 4000.00, 'url_jugo_naranja.jpg', 1),
        ('PAQ-001', 3, 'Paquete de Galletas', '30 gramos', 2000.00, 2500.00, 'url_galletas.jpg', 1),
        ('REF-001', 2, 'Refresco en Lata', '330 ml', 1500.00, 2000.00, 'url_refresco_lata.jpg', 1),
        ...
        ('CER-001', 1, 'Cerveza Light', '330 ml', 3000.00, 3500.00, 'url_cerveza_light.jpg', 1),
