            ...
            <div class="container__Main-register">
                ...
                <div class="datos-contenido">
                    <span>
                        ...
                        <input className='input-form' type="text" name="id" id="idp" placeholder="identificacion" onBlur={verificarIDExistente} onChange={(e) => setId(e.target.value)} />
                        <p id="wrongid"></p>
                    </span>
                    <span>
                        <br/><br/>
                        <label for="name">Primer Nombre</label>
                        <input className='input-form' type="text" name="name1" id="name1" placeholder="Primer Nombre"  onBlur={Verificar_name1} onChange={(e) => setName1(e.target.value)} />
                        <p id="wrongname1"></p>
                    </span>
                    <span>
                        <br/><br/>
                        <label for="name">Segundo Nombre</label>
                        <input className='input-form' type="text" name="name2" id="name2" placeholder="Segundo Nombre"  onBlur={Verificar_name2} onChange={(e) => setName2(e.target.value)} />
                        <p id="wrongname2"></p>
                    </span>
                    <span>
                        <br/><br/>
                        <label for="name">Primer apellido</label>
                        <input className='input-form' type="text" name="last1" id="last1" placeholder="Primer apellido"  onBlur={Verificar_lastname1} onChange={(e) => setLastname1(e.target.value)} />
                        <p id="wronglast1"></p>
                    </span>
                    <span>
                        <br/><br/>
                        <label for="name">Segundo apellido</label>
                        <input className='input-form' type="text" name="last2" id="last2" placeholder="Segundo apellido"  onBlur={Verificar_lastname2} onChange={(e) => setLastname2(e.target.value)} />
                        <p id="wronglast2"></p>
                    </span>
                    <span>
                        <br/><br/>
                        <label for="cel">Numero de Telefono</label>
                        <input className='input-form' type="number" name="cel" id="cel" placeholder="Numero de Telefono"  onBlur={Verificar_cel} onChange={(e) => setTel(e.target.value)} />
                        <p id="wrongcel"></p>
                    </span>
                    <span>
                        <br/><br/>
                    ...
                    <span>
                        ...
                        <input className='input-form' type="text" name="saldo" id="saldo" placeholder="Saldo inicial" onChange={(e) => setSaldo(e.target.value)}/>
                        <p id="wrongaddres"></p>
                    </span>
                    <span class="bloc">
                        <br/><br/>
